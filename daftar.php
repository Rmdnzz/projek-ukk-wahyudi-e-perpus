<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $status=1;
        $level="Anggota";
        $simpan_anggota=mysqli_query($kon,"insert into anggota (kode_anggota,nama_anggota,no_telp,email,alamat,tempat_lahir,tanggal_lahir) values ('$kode_anggota','$nama_anggota','$nomor_telp','$email','$alamat','$tempat_lahir','$tanggal_lahir')");
