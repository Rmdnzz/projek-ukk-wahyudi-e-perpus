...
// Set default value untuk $_SESSION["nama_petugas"]
...
<html lang="en">
    <head>
        ...
        <link href="../src/assets/img/book.webp" rel="icon" />
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown">
                    ...
                    <?php 
                        if ($_SESSION['level']=='Karyawan' or $_SESSION['level']=='Anggota'):
                    ?>
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                    ...
                    <?php 
                        if ($_SESSION['level']=='Karyawan' or $_SESSION['level']=='Petugas'):
                    ?>
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLaporan" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="index.php?page=laporan-peminjaman"><i class="fas fa-grip-horizontal"></i>  &nbsp; Peminjaman</a>
                                    <a class="nav-link" href="index.php?page=laporan-pustaka"><i class="fas fa-book "></i> &nbsp; Buku</a>
                            ...
                            <div class="collapse" id="collapsePustaka" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="index.php?page=pustaka"><i class="fas fa-book"></i>  &nbsp; Buku</a>
                    ...
                    ?>
                            ...
                            <div class="collapse" id="collapsePengguna" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="index.php?page=petugas"><i class="fas fa-user-tie"></i> &nbsp; petugas</a>
                                </nav>
                            </div>
