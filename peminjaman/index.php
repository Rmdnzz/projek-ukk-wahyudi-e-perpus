                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tabel_peminjaman" width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['jumlah_pustaka']; ?> Buku</td>
                            <td>
                                <a href="index.php?page=detail-peminjaman&kode_peminjaman=<?php echo $data['kode_peminjaman']; ?>" class="btn btn-success btn-circle">Detail</a>
                            </td>
                        </tr>
