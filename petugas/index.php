...
<?php
    ...
    if ($_SESSION["level"]!='Karyawan' and $_SESSION["level"]!='petugas'):
...
<script>
    ...
    // jika level nya petugas maka tidak akan menampilkan tambah petugas
    if ("<?php echo $_SESSION['level']; ?>" === 'petugas') {
        $('.btn-tambah').hide();
    }
